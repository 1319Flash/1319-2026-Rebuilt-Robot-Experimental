...
public class Telemetry {
     ...
     *
     * @param maxSpeed maximum robot speed in meters per second, used to scale module speed display
     */
    ...
    private final NetworkTable         m_poseTable       = m_inst.getTable("Pose");
    ...
    private final DoubleArrayPublisher m_fieldPub     = m_poseTable.getDoubleArrayTopic("robotPose").publish();
    private final StringPublisher      m_fieldTypePub = m_poseTable.getStringTopic(".type").publish();

    // Mechanism2d module visualizers
    ...
    /** Publishes the full swerve drive state to NetworkTables and SignalLogger. */
